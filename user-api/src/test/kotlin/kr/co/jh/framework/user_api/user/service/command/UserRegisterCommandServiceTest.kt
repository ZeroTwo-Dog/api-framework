...
internal class UserRegisterCommandServiceTest(
    @Autowired
    ...
    fun registerUser() {
        ...
        val registerUser = userAuthCommandService.registerUser(signIn)
    ...
    fun checkId() {
        ...
        assertThrows(UserDuplicateException::class.java) {
            userAuthCommandService.registerUser(
                signIn
            )
        }
